...
class Comment(db.Model):
    ...
    # "One to Many" with the BlogPost table and be as child table
...
def register():
    ...
    if form.validate_on_submit():
        ...
        #If user's email is already exist
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
    # This line of code is aim to clean the comment block
